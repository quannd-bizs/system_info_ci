...
$tinybrowser['path']['image'] = '/public/images/vip/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/public/images/vip/'; // Media files location
$tinybrowser['path']['file']  = '/public/images/vip/'; // Other files location
...
$tinybrowser['maxsize']['image'] = 524288; // Image file maximum size byte
$tinybrowser['maxsize']['media'] = 1; // Media file maximum size
$tinybrowser['maxsize']['file']  = 1; // Other file maximum size
