 ...
 * Create datagrid auto fro any DB
 * 
 */
class Datagrid {
    ...
    /**
     * Hiden field do not view on datagrid
     *
     * @param array $fields 
     */
    ...
    /**
     * Select field for view on datagrids
     *
     */
    ...
    /**
     * Auto gen data on data grids the put to rows
     *
     * @return <type>
     */
    ...
    /**
     *
     * Add button EDIT OR DEL on Data Grids
     * 
...
// get name of submitted action (if any)
    ...
    /**
     * Delete action (Physical deleted)
     *
     * @return <type>
     */
...
// remove selected items from the db
    ...
    /**
     * Delete action (logic deleted) --> update del_flag to 1
     *
     * @return <type>
     */
    public function deletePostSelection() {
